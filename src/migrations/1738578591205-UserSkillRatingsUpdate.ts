...
export class UserSkillRatingsUpdate1738578591205 implements MigrationInterface {
  name = 'UserSkillRatingsUpdate1738578591205';
...
GROUP BY
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE MATERIALIZED VIEW "user_skill_rating_materialised_view" AS SELECT
    question_response.candidate_id,
    question.skill_id,
    question_response_rating.is_ai_generated,
    SUM(question_response_rating.rating_value * CASE question.difficulty_level
